package net.cjsmc.progames.murdermystery;
...
public class MurderMysteryGame implements CommandExecutor {
            ...
            if (sender instanceof Player) {
                ...
                if (gameStarted) {
                    ...
                    if (!players.contains(player)) {
                        players.add(player);
                        scores.put(player, 0);
                        player.sendMessage("§aYou joined the Murder Mystery!");
                ...
                sender.sendMessage("§cOnly players can start Murder Mystery games.");
            }
            return true;
        }
        return false;
    ...
    private void startGame() {
        gameStarted = true;
        Bukkit.broadcastMessage("§aMurder Mystery has started! Good luck!");
    ...
    private void endGame() {
        ...
        if (winner != null) {
            Bukkit.broadcastMessage("§a" + winner.getName() + " has won the Murder Mystery!");
        } else {
