package net.cjsmc.progames.skywars;
...
public class SkyWarsGame implements CommandExecutor {
            ...
            if (sender instanceof Player) {
                ...
                if (gameStarted) {
                    ...
                    if (!players.contains(player)) {
                        players.add(player);
                        scores.put(player, 0);
                        player.sendMessage("§aYou joined the SkyWars game!");
                ...
                sender.sendMessage("§cOnly players can start SkyWars games.");
            }
            return true;
        }
        return false;
    ...
    private void startGame() {
        gameStarted = true;
        Bukkit.broadcastMessage("§aSkyWars game has started! Good luck!");
    ...
    private void endGame() {
        ...
        if (winner != null) {
            Bukkit.broadcastMessage("§a" + winner.getName() + " has won the SkyWars game!");
        } else {
